0-isupper.c is a function which checks for uppercase character.

1-isdigit.c is a function that checks for a digit (0 - 9).

2-mul.c is a function that multiplies two integers.

3-print_numbers.c is a function that prints the numbers, 0 to 9, followed by a new line.
